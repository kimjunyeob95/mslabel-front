const IMAGE_NOTIFICATION_THUMBNAIL = require("./image_notification_thumbnail.png");
const IMAGE_BRANDLABEL_THUMBNAIL = require("./image_brandlabel_thumbnail.png");
const IMAGE_SIMPLELABEL_THUMBNAIL = require("./image_simplelabel_thumbnail.png");
...
const IMAGE_FOOD_THUMBNAIL = require("./image_food_thumbnail.png");
